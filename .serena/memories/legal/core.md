...
- Transition: parts of the 2025-12-23 amendment to hazardous-machinery inspection rules, including some crane scope thresholds, take effect 2026-12-23. Keep current and future requirements separate.
- Information: Personal Data Protection Act; Trade Secrets Act; Artificial Intelligence Basic Act promulgated/effective 2026-01-14. AI Basic Act is a governance baseline and does not replace PDPA, trade-secret, IP, security, labor, or safety duties.
- Speak-up: do not assume the Public Interest Whistleblower Protection Act applies to every private employer; determine covered entity/status. Preserve separate non-retaliation rights under labor and OSH laws.
- Project-specific legal inventory remains conditional on contractor tier, project type/scale, machinery capacity, workforce thresholds, government procurement, chemicals, waste/environmental activity, foreign workers, and client/site requirements.
