...
| HX-ART-HLC13-002 | 自請離職交接與 Closeout Work-item Register | register／authority-approval | HR／Payroll／IT／Asset | 工資、費用、特休、保險、退休、資產、帳號、門禁、交接、證明與資料 |
...
Legal routing：[RESIGN／WAGE／LEAVE／INS／PENSION／SERVICE／DATA](../../governance/taiwan-legal-register.md)。
