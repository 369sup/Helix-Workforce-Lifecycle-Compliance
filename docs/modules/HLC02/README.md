...
| --- | --- | --- | --- | --- |
| HX-ART-HLC02-001 | 到職／進場 Onboarding Work-item Register | register／authority-approval | HR／Site；Employer Authority | 三類開始日期、名卡、保險、退休、資產、帳號、訓練與 blocker |
...
- 實際開始工作後不得等待行政完成才啟用工時、職災保險、退休或安全控制。
- 未具資格、訓練、健康適任或 site clearance 的工作保持 blocked。
- 輸出為 active relationship、assignment、onboarding work items 與可追溯的未完成補正。

Legal routing：[RECORD／INS／PENSION／TRIAL／OSH／DATA](../../governance/taiwan-legal-register.md)。
