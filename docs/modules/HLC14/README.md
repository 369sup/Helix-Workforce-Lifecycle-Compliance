...
| HX-ART-HLC14-003 | Employer-initiated Closeout Work-item Register | register／authority-approval | HR／Payroll／IT／Asset | severance／retirement、工資、特休、保險、退休、通報、證明、資產、權限與資料 |
...
Legal routing：[TERM／SEVERANCE／RETIRE／SERVICE／WAGE／INS／PENSION／DATA](../../governance/taiwan-legal-register.md)。
